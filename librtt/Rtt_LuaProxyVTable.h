...
// ----------------------------------------------------------------------------
	...
	class LuaOutlineTextObjectProxyVTable : public LuaTextObjectProxyVTable
	{
	public:
		typedef LuaOutlineTextObjectProxyVTable Self;
		typedef LuaTextObjectProxyVTable Super;

	public:
		static const LuaOutlineTextObjectProxyVTable& Constant();

	protected:
		LuaOutlineTextObjectProxyVTable() {}
